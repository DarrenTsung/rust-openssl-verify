...
//!
//! OpenSSL up until version 1.1.0 did not support verification that the
...
//! legitimately signed certificate to *some* domain to execute a
...
use openssl::x509::{X509StoreContextRef, X509Ref, GeneralName, X509NameRef};
use std::net::IpAddr;
use std::str;
